...
$Mail.Subject = "GBIF - ingestion paused due to occurrenceID changes"
$Mail.HTMLBody = @"
<html>
<head>
...
<body>
    <p>Hello,</p>
	<p></p>
    <p>I am contacting you from the GBIF Secretariat about the datasets:</p>
    <p>$ALL_DATASET_KEYS</p>
    <p></p>
	<p>We noticed that the occurrenceIDs were changed. We have temporarily paused the ingestions of these datasets.</p>
    <p></p>
